package com.roger.QuestionBankSpider.webmagic.downloader;
...
public class FixHttpClientDownloader  extends AbstractDownloader {

        private Logger logger = LoggerFactory.getLogger(this.getClass());
        private final Map<String, CloseableHttpClient> httpClients = new HashMap();
        private FixHttpClientGenerator fixHttpClientGenerator = new FixHttpClientGenerator();
        private HttpUriRequestConverter httpUriRequestConverter = new HttpUriRequestConverter();
        private ProxyProvider proxyProvider;
        private boolean responseHeader = true;

        public FixHttpClientDownloader() {
        }
        ...
        private CloseableHttpClient getHttpClient(Site site) {
            if (site == null) {
                return this.fixHttpClientGenerator.getClient((Site)null);
            } else {
                ...
                if (httpClient == null) {
                    synchronized(this) {
                        ...
                        if (httpClient == null) {
                            httpClient = this.fixHttpClientGenerator.getClient(site);
        ...
        public void setThread(int thread) {
            this.fixHttpClientGenerator.setPoolSize(thread);
        }
